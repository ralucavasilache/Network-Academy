...
typedef struct article_info_list_reff article_list_reff;

struct article_info_list_venue;
typedef struct article_info_list_venue article_list_venue;

struct article_info_list_author;
typedef struct article_info_list_author article_list_author;
...
void compare_author_names(PublData *data, const char *institution,
    int *nr, int i, int k1, int k2);
